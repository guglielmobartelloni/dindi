defmodule DindiWeb.TransactionLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :transactions, Transactions.list_transactions()) |> stream(:categories, [])}
  end
  ...
  @impl true
  def handle_info({DindiWeb.TransactionLive.FormComponent, {:saved, transaction}}, socket) do
